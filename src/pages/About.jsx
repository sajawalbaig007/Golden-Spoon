...
function About() {
  return (
    <div className="w-full pt-[100px] md:pt-[120px] min-h-screen bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-500 py-20 px-5 md:px-16">

      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 mt-12 md:mt-0">
        {/* mt-12 adds spacing from top in mobile, md:mt-0 resets for desktop */}
